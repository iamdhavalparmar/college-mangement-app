...
public class student_dashboard extends AppCompatActivity implements dashboardraw.ItemClickListener , NavigationView.OnNavigationItemSelectedListener{
    ...
    private Integer[] pics = {R.drawable.managetimetable, R.drawable.holiday, R.drawable.exam,
            R.drawable.placement, R.drawable.assignment, R.drawable.syllabus, R.drawable.attendance,R.drawable.complaint,R.drawable.leave};
    private String[] name = {"Time Table", "Holiday", "Exam", "Plcement", "Assignment", "Syllabus", "Attendnace","Complaint","Leave"};
    dashboardraw adp;
