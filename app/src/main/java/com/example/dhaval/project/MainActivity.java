...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean getFirstTime() {
        return !this.getSharedPreferences("FirstTime", MODE_PRIVATE).contains("isFirstTime");
    }

    public void setFirstTime() {
        this.getSharedPreferences("FirstTime", MODE_PRIVATE).edit().putBoolean("isFirstTime", false).apply();
    }
