...
import com.example.dhaval.project.faculty.f_addassignemntfloating;
import com.example.dhaval.project.model.Assignment;

import java.util.HashMap;
import java.util.List;

public class s_assistatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_assistatus);
