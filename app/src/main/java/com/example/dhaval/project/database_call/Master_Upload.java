...
public class Master_Upload {
    ...
    public JSONObject callWS(Uri uri, Context context, String FileName, String DocType, String UploadDirectory) {
        ...
        try {
            ...
            URL url = new URL("http://proglan.in/techmicra/college/master_upload.php?t_id=" + FileName + "&directory=" + UploadDirectory);
