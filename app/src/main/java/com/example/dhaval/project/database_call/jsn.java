...
import com.example.dhaval.project.general.MyListAdapter;
import com.example.dhaval.project.model.Complaint;
import com.example.dhaval.project.student.complaintadp;
...
public class jsn {
    ...
    public static void RequestMultiplePermission(Context context, int requestPermissionCode, String... permission) {
        // Creating String Array with Permissions.
        ActivityCompat.requestPermissions((Activity) context, permission, requestPermissionCode);
...
//        Log.e(TAG, "getAllObjectFromString: "+listMain.getDetail(0).toString() );
    ...
    public static HashMap<String, String> getParamSelect(String table, String where) {
    ...
    public static void setListAdapter(Activity activity, ListView lv, List<String> list) {
        MyListAdapter adp = new MyListAdapter(activity, R.layout.sturawcomplaint, list);
        lv.setAdapter(adp);
    }
    public static void setListAdapter(Activity activity, ListView lv, List<String> list1, List<String> list2) {
        MyListAdapter adp = new MyListAdapter(activity, R.layout.sturawcomplaint, list1,list2);
        lv.setAdapter(adp);
    }

    public static void setListAdapter(Activity activity, ListView lv, List<String> list1, List<String> list2, List<String> list3) {
        MyListAdapter adp = new MyListAdapter(activity, R.layout.sturawcomplaint, list1, list2, list3);
        lv.setAdapter(adp);
    }
