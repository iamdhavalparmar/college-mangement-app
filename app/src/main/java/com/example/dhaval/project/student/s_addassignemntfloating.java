...
public class s_addassignemntfloating extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if (position == 0) {
            ...
            ArrayAdapter<CharSequence> adp2 = ArrayAdapter.createFromResource(s_addassignemntfloating.this, R.array.sem2, R.layout.support_simple_spinner_dropdown_item);
            adp2.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
            spinner2.setAdapter(adp2);
        } else if (position == 1) {
            ArrayAdapter<CharSequence> adp3 = ArrayAdapter.createFromResource(s_addassignemntfloating.this, R.array.sem4, R.layout.support_simple_spinner_dropdown_item);
            adp3.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
            spinner2.setAdapter(adp3);
        } else if (position == 2) {
            ArrayAdapter<CharSequence> adp4 = ArrayAdapter.createFromResource(s_addassignemntfloating.this, R.array.sem6, R.layout.support_simple_spinner_dropdown_item);
    ...
    public class async extends AsyncTask<Uri, Uri, Uri> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBar = new ProgressBar(s_addassignemntfloating.this);
        ...
        protected void onPostExecute(Uri s) {
            ...
            try {
                if (jsonObject.getString("action").equals("1")) {
                    Toast.makeText(s_addassignemntfloating.this, "ImageUploaded", Toast.LENGTH_SHORT).show();
                    saveFile(fileName);
                }
            } catch (Exception e) {
                Toast.makeText(s_addassignemntfloating.this, "Catchimg:" + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected Uri doInBackground(Uri... uris) {
            ...
            jsonObject = master_upload.callWS(uri, s_addassignemntfloating.this, fileName, ".pdf", NetworkCall.uploadFolder.ASSIGNMENT);
    ...
    private void saveFile(String fileName) {
        ...
        assignment.setUser_id(MyParam.userId);
        ...
        NetworkCall.call(map).setDataResponseListener(new NetworkCall.SetDataResponse() {
            ...
            public void setResponse(String responseStr) {
                Toast.makeText(s_addassignemntfloating.this, "" + responseStr, Toast.LENGTH_SHORT).show();
            }
        });
